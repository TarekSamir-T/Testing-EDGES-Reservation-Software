...
/************************************************************************************
* Test ID                : TestCase_User_login_trials
* Description            : Test functionality of login
* Pre-requisits          : There is a User Assigned to DB
* Test inputs            : User name : AdminUser1
*						   Password  : Edges123
...
void Main_Test_Runner(void)
{
	...
	CU_pSuite Register_suite_positive = CU_add_suite("Register Creaet Valid Account", test1_Register_start, test1_Register_end);
	CU_pSuite Register_suite_negative = CU_add_suite("Register Creaet InValid Account", test2_Register_start, test2_Register_end);


	/* Adding Test Cases to the Test Suite*/
	CU_add_test(Register_suite_positive, "Register Creaet Valid Account", TestCase1);
	// this suite is expected to fail and not to run due to to the invalid creation of the account 
	CU_add_test(Register_suite_negative, "Register Creaet InValid Account", TestCase2);
